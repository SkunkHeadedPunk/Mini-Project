...
int aWrite10;
int desiredPulseWidth9  = 1200; // Desired pulse width for pin 9, in micro seconds 
int desiredPulseWidth10 = 1200; // Desired pulse width for pin 10, in micro seconds
...
void loop() {
  ...
  locationtogo = incomingQuad*(3.14159/2); //*incomingQuad * ;
  Serial.println(incomingQuad);
  static float e;
  static float D;
